...
export const dom = {
  ...
  modals: {
    ...
    quote: {
      ...
      bulkActions: document.getElementById("quote-bulk-actions"),
      deleteSelectedButton: document.getElementById("quote-delete-selected"),
      deleteAllButton: document.getElementById("quote-delete-all"),
      manageCancelButton: document.getElementById("quote-manage-cancel"),
